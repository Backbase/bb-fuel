...
public class AccessGroupsDataGeneratorTest {
    ...
    private static List<com.backbase.ct.dataloader.dto.entitlement.Permission> createPermissions(String businessFunction,
        String... privileges) {
        List<com.backbase.ct.dataloader.dto.entitlement.Permission> permissions = new ArrayList<>();
        permissions.add(com.backbase.ct.dataloader.dto.entitlement.Permission.builder()
