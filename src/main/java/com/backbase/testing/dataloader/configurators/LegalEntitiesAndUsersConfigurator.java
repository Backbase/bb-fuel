...
public class LegalEntitiesAndUsersConfigurator {
    ...
    public void ingestUsersUnderComposedLegalEntity(List<String> externalUserIds, String parentLegalEntityExternalId, String legalEntityExternalId, String legalEntityName) {
        this.legalEntityIntegrationRestClient
            .ingestLegalEntityAndLogResponse(composeLegalEntitiesPostRequestBody(legalEntityExternalId, legalEntityName, parentLegalEntityExternalId));
        externalUserIds.parallelStream()
            .forEach(externalUserId -> this.userIntegrationRestClient.ingestUserAndLogResponse(generateUsersPostRequestBody(externalUserId, legalEntityExternalId)));
    }
}