...
public class ContactsDataGenerator {
    ...
    public static ContactsPostRequestBody generateContactsPostRequestBody() {
        ...
        for (int i = 0; i < CommonHelpers.generateRandomNumberInRange(globalProperties.getInt(CommonConstants.PROPERTY_CONTACT_ACCOUNTS_MIN), globalProperties.getInt(CommonConstants.PROPERTY_CONTACT_ACCOUNTS_MAX)); i++) {
