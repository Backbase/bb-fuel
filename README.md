...
- Legal entity (under the root legal entity) per user array in the files [users.json](src/main/resources/resources/data/users.json) and [users-without-permissions.json](src/main/resources/resources/data/users-without-permissions.json) - configurable, see section *Custom data*

For users in the file [users.json](src/main/resources/resources/data/users.json):
...
- Random arrangements (between 10 and 50) per legal entity of these users: [users.json](src/main/resources/resources/data/users.json)
...
By default only one custom service agreement: [serviceagreements.json](src/main/resources/resources/data/serviceagreements.json)

## Users setup
By default only the following users are covered:
- Users with permissions as described under *Entitlements setup* and *Product summary setup*: [users.json](src/main/resources/resources/data/users.json)
- Users without permissions under its own legal entity (no master service agreement, function and data groups associated): [users-without-permissions.json](src/main/resources/resources/data/users-without-permissions.json)
...
1. Create json file named `users.json` custom user list conforming existing format (in this case conforming: [users.json](src/main/resources/resources/data/users.json))
